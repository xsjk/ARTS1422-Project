...
export function Calendar(data, {
  ...
  const cell = year.append("g")
	...
	.join("rect")
	  ...
	  .attr("x", i => (timeWeek.count(d3.utcYear(X[i]), X[i]) - timeWeek.count(d3.utcYear(X[0]), X[0])) * cellSize + 0.5)
  ...
  const month = year.append("g")
	.selectAll("g")
	.data(([, I]) => d3.utcMonths(d3.utcMonth(X[I[1]]), X[I[I.length - 1]]))
	.join("g");
  ...
  month.append("text")
	  .attr("x", d => timeWeek.count(d3.utcYear(d), timeWeek.ceil(d)) * cellSize - 340)
