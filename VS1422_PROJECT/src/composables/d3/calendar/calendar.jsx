...
// 	#scale
// 	constructor(){
// 		this.#value = []; this.#hours = []; this.#center = []; this.#scale = 0; 
// 	}
...
// 	setPosition(_center,_scale){this.#center=_center;this.#scale=_scale;console.log("Set成功")}
// 	Calendar(data, {
...
// 	  // brush 相关函数
// 	  var OnStart = function({selection}){
// 		// hide this
...
// 					that.#value = that.#value.filter(d => d != rect.__data__);
// 				}
// 			});
// 		}
// 	  }
// 	  var OnBrush = function({selection}) {
// 		let temp = [];
// 		if (selection) {
...
// 		} 
// 		svg.property("value", that.#value).dispatch("input");
// 	  };
// 	  var OnEnd = function({selection}){
// 		  console.log(that)
// 		update_layer(that.#value,that.#hours,that.center,that.scale);
// 	  };
// 	  // brush内容
...
// 				}
// 				else{
// 					that.#hours = hours.filter(d => d!=i.data+1)
// 					d3.select(this)
// 					.attr('opacity', 0.5)
// 					.attr('stroke', 'white')
